...
const heroContent = [
  {
    text: "Trustworthy",
    postion: "bottom-14 left-5 md:left-52 lg:left-20 2xl:left-44",
  },
  {
    text: "Online",
    postion: " bottom-52 left-0 md:left-32 lg:left-5 2xl:left-14",
  },
  {
    text: "Uinique",
...
const SectionOne = () => {
  return (
    <div className="w-full border flex flex-col pt-20 justify-between px-5 md:px-10 lg:flex-row">
      <div className="space-y-6 pt-16 w-full lg:w-1/2 border">
      ...
      <div className="relative flex justify-center w-full border lg:w-1/2">
        <Image
